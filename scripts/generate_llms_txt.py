...
- Daily digest: https://observatory.agenticstate.org/digest
- Structured data (JSONL): https://observatory.agenticstate.org/data/innovations.jsonl
  and https://observatory.agenticstate.org/data/digests.jsonl
